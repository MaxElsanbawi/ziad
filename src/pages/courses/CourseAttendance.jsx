...
const CourseAttendance = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:3000/api/atendance/courses/${courseId}/attendance`
        );
  ...
  const handleAttendanceChange = async (
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:3000/api/atendance/courses/${courseId}/registrations/${registrationId}/attendance`,
        {
          method: "POST",
